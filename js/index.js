...
class SimpleExample extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      restaurants.map(r => {
        return (
          React.createElement(Marker, { position: [r.location.latitude, r.location.longitude] },
          React.createElement(Popup, null,
          React.createElement("ul", null,
          React.createElement("li", null,

          React.createElement("h3", null, "Resturant Name:")),

          React.createElement("li", null, r.name),
          React.createElement("li", null,
          React.createElement("h3", null, "Cusines:")),

          React.createElement("li", null, " ", r.cuisines),
          React.createElement("li", null,

          React.createElement("h3", null, "Average Cost For Two:")),

          React.createElement("li", null,
          React.createElement("span", null, "$"), r.average_cost_for_two),

          React.createElement("li", null,
          React.createElement("h3", null, "User Ratings:")),

          React.createElement("li", null, " ", r.user_rating.aggregate_rating),
          React.createElement("li", null, React.createElement("h3", null, "Locality:")),
          React.createElement("li", null, r.location.locality),
          React.createElement("li", null,

          React.createElement("h3", null, "Address:")),

          React.createElement("li", null, " ", r.location.address)))));
